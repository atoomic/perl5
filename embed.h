...
#define gv_fetchpvn_flags(a,b,c,d)	Perl_gv_fetchpvn_flags_hash(aTHX_ a,b,c,d, 0)
#define gv_fetchpvn_flags_hash(a,b,c,d,h)	Perl_gv_fetchpvn_flags_hash(aTHX_ a,b,c,d,h)
