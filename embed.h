...
#define put_latin1_charclass_innards(a,b,c)	S_put_latin1_charclass_innards(aTHX_ a,b,c)
...
#define add_wide_char_to_trie(a,b,c,d,e)	S_add_wide_char_to_trie(aTHX_ a,b,c,d,e)
