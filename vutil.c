...
VER_NV:
	...
	char *buf;
         ...
         * dot, update our records as to what the locale is.  This is extremely
         * unlikely to be in a loop, so the extra work will have a negligible
         * performance impact.  See [perl #121930].
         *
...
#endif
        { /* Needed because macro declares a variable */
